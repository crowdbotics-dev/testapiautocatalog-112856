...
## Project Structure
    ...
    ├── testapiautocatalog_112856  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112856`
...
2. Clone this repo and `cd testapiautocatalog_112856`
